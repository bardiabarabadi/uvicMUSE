...
setup(
    ...
    license="MIT",
    entry_points={"console_scripts": ["uvicmuse_debug=uvicmuse_debug.__main__:main"]},
    packages=['uvicmuse_debug'],
    package_data={'uvicmuse_debug': ['docs/Header.png']},

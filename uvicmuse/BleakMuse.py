...
class BleakMuse():
    ...
    def __init__(self, address, callback_eeg=None, callback_control=None,
        ...
        # self.backend = helper.resolve_backend(backend) TODO: Rewrite

    def list_muses(self):

        pass  # TODO: Returns and saves a list of available MUSEs with their UUID

    def connect(self):
        """Connect to the device"""
        try:

            # self.adapter.start() TODO: Rewrite
            # self.device = self.adapter.connect(self.address) TODO: Rewrite
            ...
            if ("characteristic" in str(error)):
                ...
                sleep(2)
                # self.device = self.adapter.connect(self.address) TODO: Rewrite
                # self.select_preset(preset=21) TODO: Rewrite
    ...
    def _write_cmd(self, cmd):
        ...
        cmd -- list of bytes"""
        # self.device.char_write_handle(0x000e, cmd, False) TODO: Rewrite
        pass
    ...
    def disconnect(self):
        ...
        # self.device.disconnect()TODO: Rewrite
        # if self.adapter:
        #     self.adapter.stop()TODO: Rewrite
        pass

    def _subscribe_eeg(self):
        """subscribe to eeg stream."""
        # self.device.subscribe(MUSE_GATT_ATTR_TP9,
        #                       callback=self._handle_eeg) TODO: Rewrite
    ...
    def _subscribe_control(self):
        ...
        #     MUSE_GATT_ATTR_STREAM_TOGGLE, callback=self._handle_control)TODO: Rewrite
    ...
    def _subscribe_telemetry(self):
        ...
        #                       callback=self._handle_telemetry) TODO: Rewrite
        pass
    ...
    def _subscribe_acc(self):
        ...
        #                       callback=self._handle_acc) TODO: Rewrite
        pass
    ...
    def _subscribe_gyro(self):
        ...
        #                       callback=self._handle_gyro) TODO: Rewrite
        pass
